					...
					<div class="p-6 flex flex-col gap-4">
						...
						<div class="mt-4 border-t border-base-200 pt-4">
							...
							<div class="mt-6 flex justify-center">
								<a href="/hello" class="px-6 py-2 bg-gradient-to-br from-blue-500 to-purple-600 text-white font-medium rounded-full shadow-md hover:shadow transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
