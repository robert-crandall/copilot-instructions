...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-DSk6_6vi.js')),
			__memo(() => import('./chunks/1-BBEKyC4f.js')),
			__memo(() => import('./chunks/2-BKwmqE9w.js')),
			__memo(() => import('./chunks/3-oW9VYXkA.js')),
			__memo(() => import('./chunks/4-BDU29IXi.js')),
			__memo(() => import('./chunks/5-B0Wv_p7H.js')),
			__memo(() => import('./chunks/6-BnCVRU5y.js'))
		],
		routes: [
			{
				id: "/",
